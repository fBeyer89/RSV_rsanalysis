...
for subject in subjects:
    ...
    working_dir = '/scr/kennedy2/data_fbeyer/BIPS/WDR/Lemon/' +subject+'/'
    #print working_dir
    data_dir = '/scr/kennedy2/data_fbeyer/Subjects/'+subject+'/'
    out_dir = '/scr/kennedy2/data_fbeyer/Subjects/'+subject+'/'
    freesurfer_dir = '/scr/kennedy2/data_fbeyer/freesurfer/'
