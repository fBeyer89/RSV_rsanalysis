...
side="left" #CHANGE IN HC.py so that correct FS side is selected!!!
for subject in subjects:
    ...
    #hc_brain_mask='/data/pt_nro148/3T/restingstate_and_freesurfer/preprocessing/preprocessed/'+subject+'/hc_connectivity_thr099/'+side+'/hc_masks/anterior_hc/hc_mask_thr0.99.nii.gz'
