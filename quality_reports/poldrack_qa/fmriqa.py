...
FDthresh=0.5
DVARSthresh=0.5
#from Power, 2012: http://www.sciencedirect.com/science/article/pii/S1053811911011815
...
def fmriqa(infile,TR,outdir=None,maskfile=None,motfile=None,verbose=False,plot_data=True):
    ...
    badvol_index_orig=N.where((fd>FDthresh)*(DVARS>DVARSthresh))[0]#bad volumes are those where both meanFD >0.5 mm AND DVARS >0.5.
